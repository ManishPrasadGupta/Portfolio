    ...
    return (
        <div className="flex flex-col h-full w-full">
            ...
            >
                ...
                <a href="https://ananymous-text-u812.vercel.app/" target="_blank" rel="noopener noreferrer" className="block flex-1">
                    <img 
                        className="w-full h-48 object-cover rounded-lg mx-auto p-4"
                        src="https://res.cloudinary.com/mnisprsd/image/upload/v1736080149/Screenshot_2025-01-05_175829_v1hmyi.png" 
                        alt="Anonymous Feedback Screenshot" 
                    />
                </a>
