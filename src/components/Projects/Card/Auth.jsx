    ...
    return (
        <div className="flex flex-col h-full w-full">
            ...
            >
                ...
                <a href="https://mern-auth-g00f.onrender.com/" target="_blank" rel="noopener noreferrer" className="block flex-1">
                    <img 
                        className="w-full h-48 object-cover rounded-lg mx-auto p-4"
                        src="https://res.cloudinary.com/mnisprsd/image/upload/v1743592631/auth_mudtzn.png"
                        alt="Authentication System Preview" 
                    />
                </a>
                <div className="flex-1 px-6 pb-5 flex flex-col justify-between">
                    <a href="https://mern-auth-g00f.onrender.com/" target="_blank" rel="noopener noreferrer">
